...
transport = Transport(id="Transport", current_location="МИФИ")
print(transport.get_info())
transport.move("м. Каширская", 60)
print(transport.get_info())
transport.charge(15)
print(transport.get_info())
...
scooter.move("Торговый центр", 20)
...
delivery_drone = DeliveryDrone(id="DeliveryDrone", current_location="Пекарня")
print(delivery_drone.get_info())
print(delivery_drone.calculate_route("Пекарня", "Адрес доставки"))
delivery_drone.deliver_package()
delivery_drone.load_package("Тортик")
print(delivery_drone.get_info())
delivery_drone.deliver_package()
delivery_drone.load_package("Тортик")
...
delivery_drone.land()
print(delivery_drone.get_info())
print(delivery_drone.calculate_route("Адрес доставки", "Пекарня"))
