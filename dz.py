...
if __name__ == "__main__":
    print("..... Тестирование ElectricScooter .....")
    scooter = ElectricScooter("A01", current_location = "Парк Коломенское")
    print(scooter.get_info())

    scooter.move("Торговый центр", 25)  # Попытка поехать без аренды
    scooter.is_rented = True
    scooter.move("Торговый центр", 25)
    print(scooter.get_info())
    ...
    drone = Drone("B01", current_location = "МИФИ")
    print(drone.get_info())

    drone.move("Парк Коломенское", 15)  # Попытка лететь без взлёта
    drone.take_off(50)
    drone.move("Парк Коломенское", 15)
    print(drone.get_info())
    ...
    print("..... Тестирование DeliveryDrone .....")
    delivery_drone = DeliveryDrone("D01", current_location = "МИФИ")
    print(delivery_drone.get_info())

    delivery_drone.take_off(30)
    delivery_drone.load_package("Книга Демидович")
    print(delivery_drone.calculate_route("МИФИ", "Общежитие"))
    delivery_drone.move("Общежитие", 15)
